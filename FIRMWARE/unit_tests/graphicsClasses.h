...
public:
    ...
    void draw();
    bool check(Point a);
    bool checkWithTitle(Point a, std::string title);
};
...
public:
    ...
    unsigned long bg  = HX8357_BLACK;
    unsigned long txt = HX8357_WHITE;
    int textSize = 12;
...
class Clock_display{
    int hour,  minute,  second, phour, pminute, psecond, x, y;
